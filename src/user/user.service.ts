    ...
    async getTable() {
        ...
        e.forEach(cure => {
            ...
            cure.received.forEach(curuserto => {
                final[curuserto.id].spent += Math.ceil(cure.amount / cure.received.length)
        ...
        u.forEach(cur => {
            final[cur.id].balance = final[cur.id].paid - final[cur.id].spent + final[cur.id].transferfrom - final[cur.id].transferto
        })
